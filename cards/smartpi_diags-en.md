...
| FFTrim PI rebalance | `{{ fftrim_pi_rebalance_reason }}` · ΔFF `{{ '%+.3f' | format(fftrim_pi_rebalance_delta * 100) }}%` · ΔI `{{ '%+.3f' | format(fftrim_pi_rebalance_integral_delta) }}` · pending {{ fftrim_pi_rebalance_pending }} |
