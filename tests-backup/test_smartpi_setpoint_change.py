...
from custom_components.versatile_thermostat.smartpi.ab_estimator import TauReliability
from custom_components.versatile_thermostat.smartpi.const import GovernanceDecision
from custom_components.versatile_thermostat.smartpi.feedforward import compute_ff as compute_ff_impl
...
def test_smartpi_feedforward_uses_raw_setpoint_when_trajectory_is_active():
    ...
    assert target_temp_filt < target_temp
    ...
    with patch(
        "custom_components.versatile_thermostat.prop_algo_smartpi.compute_ff",
